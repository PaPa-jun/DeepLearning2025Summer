...
# model = SimCLRModel(encoder, 128).to("cuda")
...
# pretrain(model, train_loader, test_loader, optimizer, criterion, 50, 10, "cuda")

pretrained_model = SimCLRModel(encoder, 128)
...
test_model(classifier, test_loader, "cuda")
